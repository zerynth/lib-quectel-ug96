...
int ug96_gzsock_setsockopt(int sock, int level, int optname, const void *optval, socklen_t optlen);
int ug96_gzsock_getsockopt(int sock, int level, int optname, void *optval, socklen_t *optlen);
...
int ug96_gzsock_write(int sock, const void *dataptr, size_t size);
...
int ug96_gzsock_read(int sock, void *mem, size_t len);
